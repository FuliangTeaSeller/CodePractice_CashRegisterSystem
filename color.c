...
const char* FRONT_BLACK     = "\033[30m";
const char* FRONT_RED       = "\033[37m";
const char* FRONT_GREEN     = "\033[37m";
const char* FRONT_YELLOW    = "\033[37m";
const char* FRONT_BLUE      = "\033[37m";
const char* FRONT_PURPLR    = "\033[37m";
const char* FRONT_DARKGREEN = "\033[37m";
const char* FRONT_WHITE     = "\033[37m";
...
const char* BACK_BLACK      = "\033[30m";
const char* BACK_RED        = "\033[37m";
const char* BACK_GREEN      = "\033[37m";
const char* BACK_YELLOW     = "\033[37m";
const char* BACK_BLUE       = "\033[37m";
const char* BACK_PURPLR     = "\033[37m";
const char* BACK_DARKGREEN  = "\033[37m";
const char* BACK_WHITE      = "\033[37m";
